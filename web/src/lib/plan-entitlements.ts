...
export const PLAN_DEFINITIONS = {
  free: {
    ...
    limits: { transactions: 40, accounts: 2, cards: 1, goals: 1, categoriesPerType: 7, aiQueriesDaily: 0, aiActionsDaily: 0 },
    features: ["40 lançamentos por mês", "2 contas, 1 cartão e 1 objetivo", "7 categorias por tipo", "Fluxo mensal e relatórios resumidos", "Contas compartilhadas"],
  },
  smart: {
    name: "Pro", description: "Mais capacidade e automação para o dia a dia", badge: "Mais popular",
    limits: { transactions: 150, accounts: 5, cards: 3, goals: 3, categoriesPerType: 14, aiQueriesDaily: 60, aiActionsDaily: 15 },
    features: ["150 lançamentos por mês", "5 contas, 3 cartões e 3 objetivos", "14 categorias por tipo", "Fluxo diário, extrato e conciliação", "Relatórios completos por categoria", "IA básica: 60 consultas e 15 ações por dia"],
  },
  premium: {
    name: "Plus", description: "Controle completo com análises avançadas", badge: "Completo",
    limits: { transactions: null, accounts: null, cards: null, goals: null, categoriesPerType: null, aiQueriesDaily: 200, aiActionsDaily: 50 },
    features: ["Lançamentos e recursos ilimitados", "Todos os recursos do Pro", "Projeções e análises avançadas", "IA completa: 200 consultas e 50 ações por dia", "Contas compartilhadas"],
  },
} as const;
